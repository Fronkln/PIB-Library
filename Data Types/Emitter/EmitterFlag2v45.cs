...
namespace PIBLib
{
    ...
    public enum EmitterFlag2v45 : int
    {
        ...
        eFLG_VECTOR_FIELD = 1 << 18,
        eFLG_VECTOR_FIELD_ANIM = 1 << 19,
        eFLG_VECTOR_FIELD_LIFE = 1 << 20,
        eFLG_RIBON = 1 << 21,
        eFLG_TRACK = 1 << 22,
        eFLG_TRACK_CROSS = 1 << 23,
        eFLG_TRACK_OVERWRITE = 1 << 24,
        eFLG_TRACK_NOISE = 1 << 25,
        eFLG_CURL_NOISE = 1 << 26,
        eFLG_TIME_FADE = 1 << 27,
        eFLG_GATHER = 1 <<  28,
        Flag28 = 1 << 29,
        Flag29 = 1 << 30,
