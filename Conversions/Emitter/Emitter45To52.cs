    ...
    public static class Emitter45To52
    {
        public static PibEmitterv52 Convert(PibEmitterv45 emitterv45)
        {
            ...
            foreach (Enum flag in flags.GetFlags())
            {
                ...
                uint de2Value = System.Convert.ToUInt32(Enum.Parse(typeof(EmitterFlag1v52), flagStr));
            ...
            foreach (Enum flag in flags3.GetFlags())
            {
                ...
                try
                {
                    uint de2Value = System.Convert.ToUInt32(Enum.Parse(typeof(EmitterFlag3v52), flagStr));
                    de2Flags3 |= de2Value;
                }
                catch
                {
            ...
            de2Flags3 |= (ulong)EmitterFlag3v52.eFLG_TEX_A1_WRAP_CLAMP;
